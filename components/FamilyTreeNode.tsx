    ...
    >
      <div className="relative flex flex-col items-center">
        ...
        <div className="relative">
          ...
          {/* Gender Icon */}
          <div className="absolute -bottom-1 -right-1 text-2xl bg-white rounded-full p-1 shadow-lg border-2 border-white">
            {genderStyle.icon}
          </div>
        </div>
        ...
        <motion.div
          ...
          className="mt-4 bg-gradient-to-br from-white to-gray-50 rounded-xl shadow-lg p-4 min-w-[200px] max-w-[220px] border border-gray-200 group-hover:shadow-2xl group-hover:border-emerald-300 transition-all duration-300"
        >
          {/* Nombre */}
