export default function WaveDivider({ inverted = false }: { inverted?: boolean }) {
  return (
    <div className="relative w-full overflow-hidden">
      ...
      >
        ...
        {/* Onda media (azul cielo transparente) */}
        <path
          ...
          fill="currentColor"
          className="text-sky-100 opacity-30"
        />

        {/* Onda frontal (muy transparente) */}
        <path
